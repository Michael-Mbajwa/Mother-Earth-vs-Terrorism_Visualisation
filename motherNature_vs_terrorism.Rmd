...
# Effort 3
This effort will be a chart comparing yearly deaths from natural disasters against terrorism.
...
total_deaths %>%
  ...
  # Change position of y axis to the right side
...
ggplot() +
  ...
  annotate("text", x = 10,  y = 10, label = "VS.  Mother Nature",
           color = "#1e3d59", size = 6, fontface = 4, hjust = 0.57) + theme_void() -> text_plot
```
