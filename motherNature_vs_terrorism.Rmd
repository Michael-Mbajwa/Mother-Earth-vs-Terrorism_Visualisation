...
Load the datasets
```{r}
fatalities <- read_csv("/Users/mac/My-R-graph-gallery/data/fatalities-from-terrorism.csv")

disasters <- read_csv("/Users/mac/My-R-graph-gallery/data/number-of-deaths-from-natural-disasters.csv")
```
