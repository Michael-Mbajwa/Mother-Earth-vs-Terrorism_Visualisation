...
Load the datasets
```{r}
deaths_terrorism <- read_csv("/Users/mac/My-R-graph-gallery/data/fatalities-from-terrorism.csv")

deaths_disasters <- read_csv("/Users/mac/My-R-graph-gallery/data/number-of-deaths-from-natural-disasters.csv")
