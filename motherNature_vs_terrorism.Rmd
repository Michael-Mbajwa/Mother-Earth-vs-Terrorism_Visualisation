...
total_deaths %>%
  ...
  annotate(geom = "curve", x = 214400	, y = "1987", xend = 150000, yend = "1984",
           ...
           color = "firebrick") +
  annotate(geom = "text", x = 215000, y = "1987", 
           label = "459842 deaths.\nNoteable: The devastating impact \nof drought in Ethiopia.", 
  ...
  annotate(geom = "text", x = 215000, y = "2014", 
           label = "Noteable: Port-au-Prince earthquake, Haiti.", 
           hjust = "left", color = "#1e3d59", size = 3, fontface = 2) +
  labs(title = "Deaths by natural disasters") +
  theme(axis.text.y = element_text(color="#1e3d59", margin = margin(r=10)),
        ...
        title = element_text(face = "bold.italic", color = "#1e3d59", size = 8.5))
```
...
total_deaths %>%
  ...
  scale_x_reverse(expand = c(0, 0), labels = comma) +
  theme_classic() +
  labs(title = "Deaths by Terrorism") +
  annotate(geom = "text", x = 45000, y = "1971", 
           label = "Data source: https://ourworldindata.org", 
           hjust = "left", color = "#1e3d59", size = 2.8, fontface = 2) +
  annotate(geom = "curve", x = 30000, y = "2011", xend = 25000, yend = "2014",
           curvature = .1, arrow = arrow(length = unit(2, "mm")), 
           color = "#1e3d59") +
  annotate(geom = "text", x = 30000, y = "2007",
           label = "The taliban killed 4111 in Afghanistan.\nBoko Haram killed 6333 in Nigera, 779 in Cameroun.\nISIL killed 8604 in Iran.",color = "#1e3d59", size = 3, fontface = 2) +
  labs(title = "Deaths by natural disasters") +
